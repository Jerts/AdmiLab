    ...
    <div style="width:90%; margin: 300px auto;">
      <div class="card">
		...
		<span class="span-perfil" style="position:absolute; top:230px;">
			<span style="background: url('assets/img/faces/face-0.jpg'); width:130px !important; height: 130px !important; background-size: auto 130px; background-position: center;display:inline-block" class="circle" id="img-perfil"></span>
		</span>
